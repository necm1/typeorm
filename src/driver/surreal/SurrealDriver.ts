...
export class SurrealDriver implements Driver {
    ...
    parseTableName(target: string | Table | View | TableForeignKey | EntityMetadata): { tableName: string; schema?: string | undefined; database?: string | undefined; } {
        throw new Error("Method not implemented.");
    }
    ...
    normalizeType(column: { type?: string | DateConstructor | BooleanConstructor | NumberConstructor | StringConstructor | undefined; length?: string | number | undefined; precision?: number | null | undefined; scale?: number | undefined; isArray?: boolean | undefined; }): string {
        throw new Error("Method not implemented.");
    }
